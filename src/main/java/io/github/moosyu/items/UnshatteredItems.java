...
public class UnshatteredItems {
    ...
    public static final DeferredItem<FishingRodItem> FISHING_ROD = ITEMS.registerItem("fishing_rod", props -> new FishingRodItem(props
            .stacksTo(1)
            .component(DataComponentRegistry.ITEM_TYPE.get(), ItemTypes.FISHING_ROD)
            .component(DataComponentRegistry.DESCRIPTION.get(), true)
            .attributes(ItemAttributeModifiers.builder()
