...
public class ItemsRegistry {
    ...
    public static final DeferredItem<NNOAxeTool> TREECAPITATOR = ITEMS.register("treecapitator", () -> new NNOAxeTool(Tiers.GOLD, new Item.Properties().component(DataComponentRegistry.RARITY.get(), RarityTypes.EPIC).component(DataComponentRegistry.ITEM_TYPE.get(), ItemTypes.AXE).attributes(
    ...
    // todo: make it so the foraging fortune only applies in certain areas (the park, not the galatea)
    public static final DeferredItem<NNOAxeTool> SPRUCE_AXE = ITEMS.register("spruce_axe", () -> new NNOAxeTool(Tiers.WOOD, new Item.Properties().component(DataComponentRegistry.RARITY.get(), RarityTypes.UNCOMMON).component(DataComponentRegistry.ITEM_TYPE.get(), ItemTypes.AXE).attributes(
        ItemAttributeModifiers.builder().add(ModAttributes.SWEEP.holder,
    ...
    public static final DeferredItem<NNOAxeTool> SERIOUSLY_DAMAGED_AXE = ITEMS.register("seriously_damaged_axe", () -> new NNOAxeTool(Tiers.WOOD, new Item.Properties().component(DataComponentRegistry.RARITY.get(), RarityTypes.UNCOMMON).component(DataComponentRegistry.ITEM_TYPE.get(), ItemTypes.AXE).attributes(
        ItemAttributeModifiers.builder().add(ModAttributes.SWEEP.holder,
    ...
    public static final DeferredItem<NNOAxeTool> DECENT_AXE = ITEMS.register("decent_axe", () -> new NNOAxeTool(Tiers.WOOD, new Item.Properties().component(DataComponentRegistry.RARITY.get(), RarityTypes.RARE).component(DataComponentRegistry.ITEM_TYPE.get(), ItemTypes.AXE).attributes(
        ItemAttributeModifiers.builder().add(ModAttributes.SWEEP.holder,
    ...
    public static final DeferredItem<NNOAxeTool> FIG_HEW = ITEMS.register("fig_hew", () -> new NNOAxeTool(Tiers.WOOD, new Item.Properties().component(DataComponentRegistry.RARITY.get(), RarityTypes.RARE).component(DataComponentRegistry.ITEM_TYPE.get(), ItemTypes.AXE).attributes(
        ItemAttributeModifiers.builder().add(ModAttributes.SWEEP.holder,
    ...
    public static final DeferredItem<NNOAxeTool> FIGSTONE_SPLITTER = ITEMS.register("figstone_splitter", () -> new NNOAxeTool(Tiers.STONE, new Item.Properties().component(DataComponentRegistry.RARITY.get(), RarityTypes.EPIC).component(DataComponentRegistry.ITEM_TYPE.get(), ItemTypes.AXE).attributes(
        ItemAttributeModifiers.builder().add(ModAttributes.SWEEP.holder,
