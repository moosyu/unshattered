...
public class HealthBarLayer implements LayeredDraw.Layer {
    ...
    public void render(GuiGraphics graphics, DeltaTracker deltaTracker) {
        ...
        final double currentHealth = player.getData(PLAYER_STATS.get()).getCurrentStat(PlayerStatsAttachment.Stat.HEALTH);
        final double maxHealth = player.getAttributeValue(AttributesRegistry.HEALTH);
